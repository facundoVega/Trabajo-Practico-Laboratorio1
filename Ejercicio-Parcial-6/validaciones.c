...
float validar_flotante(char mensaje[],float min)
{
      int a=0;
      double aux;
      float num;
...
/*cuenta la cantidad de elementos que tiene el array de floats mayores al valor pasado como promedio
...
*/
void mostrar_mayores_importes(float mayor,int codigo[],char descripcion[][51],int cantidad[],float importe[])
{
     int i;
     printf("MAYOR IMPORTE:$%.2f\n\n\n\n",mayor);
     printf("PRODUCTOS QUE SUPERAN EL MAYOR IMPORTE:\n\n");
